...
#ifndef AURORA_CLIENT_WLRLAYERSURFACEV1_H
#define AURORA_CLIENT_WLRLAYERSURFACEV1_H
...
class LIRIAURORACLIENT_EXPORT WlrLayerSurfaceV1 : public QObject
{
    Q_OBJECT
...
#endif // AURORA_CLIENT_WLRLAYERSURFACEV1_H
