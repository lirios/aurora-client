...
#include <LiriAuroraClient/private/aurora-client-wlr-export-dmabuf-unstable-v1.h>
...
class LIRIAURORACLIENT_EXPORT WlrExportDmabufManagerV1Private
        : public PrivateClient::zwlr_export_dmabuf_manager_v1
{
public:
...
class LIRIAURORACLIENT_EXPORT WlrExportDmabufFrameV1Private
        : public PrivateClient::zwlr_export_dmabuf_frame_v1
{
