...
Q_LOGGING_CATEGORY(gLcWlrLayerShellV1, "aurora.client.wlrlayershellv1")
...
void WlrLayerSurfaceV1::setWindow(QWindow *window)
{
    ...
    if (d->initialized) {
        qCWarning(gLcWlrLayerShellV1, "Unable to change WlrLayerSurfaceV1::window after initialization");
        return;
    }
...
void WlrLayerSurfaceV1::setLayer(WlrLayerSurfaceV1::Layer layer)
{
    ...
    if (d->initialized && !d->setLayerEnabled) {
        qCWarning(gLcWlrLayerShellV1, "Unable to change WlrLayerSurfaceV1::layer after initialization");
        return;
    }
...
void WlrLayerSurfaceV1::setRole(const QString &role)
{
    ...
    if (d->initialized) {
        qCWarning(gLcWlrLayerShellV1, "Unable to change WlrLayerSurfaceV1::role after initialization");
        return;
    }
...
void WlrLayerSurfaceV1::initialize()
{
    ...
    if (!d->window) {
        qCWarning(gLcWlrLayerShellV1, "Window not assigned to WlrLayerSurfaceV1, failed to initialize");
        return;
    }
