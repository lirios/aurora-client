...
#ifndef AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_H
#define AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_H
...
class LIRIAURORACLIENT_EXPORT WlrForeignToplevelManagerV1
...
class LIRIAURORACLIENT_EXPORT WlrForeignToplevelHandleV1 : public QObject
{
    Q_OBJECT
...
#endif // AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_H
