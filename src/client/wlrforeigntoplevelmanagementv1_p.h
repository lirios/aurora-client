...
#ifndef AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_P_H
#define AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_P_H

#include <QLoggingCategory>

#include <LiriAuroraClient/WlrForeignToplevelManagerV1>
#include <LiriAuroraClient/private/aurora-client-wlr-foreign-toplevel-management-unstable-v1.h>
...
Q_DECLARE_LOGGING_CATEGORY(gLcWlrForeignToplevelManagementV1)

class LIRIAURORACLIENT_EXPORT WlrForeignToplevelManagerV1Private
...
class LIRIAURORACLIENT_EXPORT WlrForeignToplevelHandleV1Private
...
#endif // AURORA_CLIENT_WLRFOREIGNTOPLEVELMANAGEMENTV1_P_H
